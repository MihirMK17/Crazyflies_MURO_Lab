...
public:
    ...
    , tf_broadcaster_(node)
  {
    ...
    // Implement the cmd_world_velocity subscription here!
    //subscription_cmd_velocity_world_ = node->create_subscription<crazyflie_interfaces::msg::VelocityWorld>(name + "/cmd_velocity_world", rclcpp::SystemDefaultsQoS(), std::bind(&CrazyflieROS::cmd_velocity_world, this, _1), sub_opt_cf_cmd);
    subscription_cmd_hover_ = node->create_subscription<crazyflie_interfaces::msg::Hover>(name + "/cmd_hover", rclcpp::SystemDefaultsQoS(), 
std::bind(&CrazyflieROS::cmd_hover, this, _1), sub_opt_cf_cmd);
...
private:
  ...
  void cmd_hover(const crazyflie_interfaces::msg::Hover::SharedPtr msg) {
    float vx = msg->vx;
    float vy = msg->vy;
    float yawrate = msg->yaw_rate;
    float zDistance = msg->z_distance;
    cf_.sendHoverSetpoint(vx, vy, yawrate, zDistance);
  }
  ...
  //void cmd_velocity_world(const crazyflie_interfaces::msg::VelocityWorld::SharedPtr msg) {
  //  float x = msg->vel.x;
  //  float y = msg->vel.y;
  //  float z = msg->vel.z;
  //  float yawRate = msg->yaw_rate;
...
public:
      ...
      , logger_(rclcpp::get_logger("all"))
  {
    ...
    //subscription_cmd_velocity_world_ = this->create_subscription<crazyflie_interfaces::msg::VelocityWorld>("all/cmd_full_state", rclcpp::SystemDefaultsQoS(), std::bind(&CrazyflieServer::cmd_velocity_world, this, _1), sub_opt_all_cmd); 
    subscription_cmd_hover_ = this->create_subscription<crazyflie_interfaces::msg::Hover>("all/cmd_hover", rclcpp::SystemDefaultsQoS(), std::bind(&CrazyflieServer::cmd_hover, this, _1), sub_opt_all_cmd);
...
//    for (auto &bc : broadcaster_) {
//    	auto &cfbc = bc.second;
//    	cfbc->sendVelocityWorldSetpoint(
//    	x, y, z, yawRate);
//    }
